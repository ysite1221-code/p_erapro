            ...
            <div class="form-group" style="margin-bottom:24px;">
                <label style="display:flex; align-items:flex-start; gap:10px; font-weight:normal; cursor:pointer;">
                    ...
                    <span style="font-size:0.88rem; color:#555; line-height:1.6;">
                        <a href="terms.php" target="_blank" style="color:#d4af37; font-weight:bold;">利用規約</a>
                        および
                        <a href="privacy.php" target="_blank" style="color:#d4af37; font-weight:bold;">プライバシーポリシー</a>
                        に同意する（必須）
                    </span>
                </label>
            </div>
